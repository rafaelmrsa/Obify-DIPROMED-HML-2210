...
±±³Descri‡„o ³ Chama relatório de Resumo de vendas limitando acesso por   ³±±
±±³          ³ usuarios                                                   ³±±
...
If Upper(U_DipUsr()) $ cUserAuth
	U_UMATR660()
Else 
	Aviso('Atenção',Upper(U_DipUsr())+ ' você não tem autorização para utilizar este relatório.',{'Ok'})
Endif                 
