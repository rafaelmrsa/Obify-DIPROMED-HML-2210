...
oDacte:Say(0130, 0205, 'Inscrição Estadual: ' + AllTrim(SM0->M0_INSC)	,oFont08)	//CNPJ e IE
...
oDacte:Say(0100, 382, "Rodoviário", oFont08 )
...
oDacte:Say(0111, 0380, "Número" , oFont08N)	//Numero
...
oDacte:Say(0130, 0375, "Emissão", oFont08N)//Emissao
...
oDacte:Say(0156, 0073, "Tipo de Serviço"             , oFont08N)

oDacte:Box(0167, 0000, 0184 , 0158)
oDacte:Say(0173, 0003, "Tomador do Serviço"          , oFont08N)
oDacte:Say(0173, 0073, "Forma de Pagamento"          , oFont08N)

oDacte:Box(0184, 0000, 0201 , 0158)
oDacte:Say(0190, 0003, "Número do Protocolo"         , oFont08N)

oDacte:Box(0201, 0000, 0218 , 0158)
oDacte:Say(0207, 0003, "Insc.Suframa do Destinatário", oFont08N)
...
ElseIf (cTpServ == '1')
	oDacte:Say(0163, 0073, "SUBCONTRATAÇÃO"		, oFont08)
ElseIf (cTpServ == '2')
	oDacte:Say(0163, 0073, "REDESPACHO"			, oFont08)
ElseIf (cTpServ == '3')
	oDacte:Say(0163, 0073, "REDESPACHO INTERM"			, oFont08)	//--Redespacho Intermediário
ElseIf (cTpServ == '4')
	oDacte:Say(0163, 0073, "SERV.VINC.MULTIMODAL"			, oFont08)	//--Serviço vinculado Multimodal
	lMultModal := .T.
Else
	oDacte:Say(0163, 0073, "NORMAL"				, oFont08)
EndIf
...
If Type("oNfe:_CTE:_INFCTE:_IDE:_TOMA03:_TOMA:TEXT") <> "U"
	...
	ElseIf oNfe:_CTE:_INFCTE:_IDE:_TOMA03:_TOMA:TEXT == "3"
		oDacte:Say(0180,  0003, "DESTINATÁRIO"  , oFont08)
		oDacte:Say(0180,  0073, "A PAGAR"       , oFont08)
	EndIf
ElseIf Type("oNfe:_CTE:_INFCTE:_IDE:_TOMA4:_TOMA:TEXT") <> "U"
	If oNfe:_CTE:_INFCTE:_IDE:_TOMA4:_TOMA:TEXT == "4"
