...
Local aOrdem		:= {"Ordem de Separação"}//"Ordem de Separação"
...
While !(cAliasOS)->(Eof())
	...
	oPrinter:SayAlign(li+100,nColEnd,"Endereço",oFontC8,200,200,,0)//"Endereço"
	...
	oPrinter:SayAlign(li+100,nSerie,"Num. Série",oFontC8,200,200,,0)//"Num. Série"
	...
	While !(cAliasOS)->(Eof()) .and. (cAliasOS)->CB8_ORDSEP == cOrdSep
		...
		If nLinCount == nMaxLinha
			...
			oPrinter:SayAlign(nLiItm,nColEnd,"Endereço",oFontC8,200,200,,0)//"Endereço"
			...
			oPrinter:SayAlign(nLiItm,nSerie,"Num. Série",oFontC8,200,200,,0)//"Num. Série"
...
oPrinter:SayAlign(li+20,340,"Impressão das Ordens de Separação",oFontA12,nMaxCol-nMargEsq,200,2,0)//"Impressão das Ordens de Separação"
...
oPrinter:SayAlign(li+30,nCol1Dir,"Emissão : ",oFontA7,200,200,,0)//"Emissão : "
...
ElseIf Alltrim(cOrigem) == "3" // Ordem de Producao
	oPrinter:SayAlign(li+60,nMargDir+160,"Ordem de Produção:",oFontC8,200,200,,0)//"Ordem de Produção:"
