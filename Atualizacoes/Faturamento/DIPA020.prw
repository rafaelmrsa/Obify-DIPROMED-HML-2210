...
ฑฑบPrograma  ณ DIPA020  บ Autor ณ Eriberto Elias     บ Data ณ  24/03/03   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ percentuais de comissoes por vendedor/operador e periodo   บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
If !(Upper(U_DipUsr()) $ AllTrim(GetNewPar("ES_DIPA020","MCANUTO/PMENDONCA/DDOMINGOS/VEGON/RBORGES/BRODRIGUES")))
	Alert(Upper(U_DipUsr())+", voc๊ nใo tem autoriza็ใo para utilizar esta rotina. Qualquer d๚vida falar com Eriberto!","ES_DIPA020")	
	Return()
EndIF
