...
ฑฑบPrograma  ณUMATA241  บAutor  ณMicrosiga           บ Data ณ  04/04/14   บฑฑ
...
If l240
	...
	EndIf
Else
	Aviso("ES_MATA240","Usuแrio sem autoriza็ใo para realizar esta opera็ใo.",{"Ok"},1)
EndIf
...
If l242      
	...
	EndIf
Else
	Aviso("ES_MATA242","Usuแrio sem autoriza็ใo para realizar esta opera็ใo.",{"Ok"},1)
EndIf
