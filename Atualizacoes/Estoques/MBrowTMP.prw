...
ฑฑบPrograma  ณMBROWTMP  บAutor  ณMicrosiga           บ Data ณ  12/10/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Fun็ใo feita com arquivo temporแrio para nใo comprometer o บฑฑ
ฑฑบ          ณ desempenho utilizando a tabela SB8 direto.                 บฑฑ
...
Private _cIndex		:= ""
Private _cChave		:= ""
Private aRotina 	:= {{"Enviar Promo็ใo"    ,"u_DipEnvPro()",0,4},;
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณMBROWTMP  บAutor  ณMicrosiga           บ Data ณ  12/11/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
If Aviso("Aten็ใo","Confirma o retorno do produto "+AllTrim(TRBBLQ->RB_PRODUTO)+"-"+AllTrim(TRBBLQ->RB_DESCRIC)+" para venda normal?",{"Sim","Nใo"},2)==1
	...
	SB8->(MsUnLock())        
	Aviso("Aten็ใo","Produto retornou para o estoque.",{"Ok"},1)
EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณMBROWTMP  บAutor  ณMicrosiga           บ Data ณ  12/15/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
BrwLegenda("Avalia็ใo de Produtos","Status",aLegenda)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณMBROWTMP  บAutor  ณMicrosiga           บ Data ณ  12/20/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
If !("DIPAL10" $ FUNNAME()) .AND. !("TMK"$FunName()) 
	...
	If !Empty(aCols[n,nPosLot])
		Aviso("Aten็ใo","Este produto jแ possui um lote promocional informado",{"Ok"},1)
		lRet := .F.
	EndIf 
	...
	If lRet	
		...
		aAdd(aHeadPro,{"C๓digo"	   		,"B8_PRODUTO","@!"			   ,15,0,"","€€€€€€€€€€€€€€","C","","" })
		aAdd(aHeadPro,{"Descri็ใo" 		,"B1_DESC"   ,"@!"			   ,60,0,"","€€€€€€€€€€€€€€","C","","" })
		aAdd(aHeadPro,{"Lote"	   		,"B8_LOTECTL","@!"			   ,10,0,"","€€€€€€€€€€€€€€","C","","" })
		aAdd(aHeadPro,{"Validade"  		,"B8_DTVALID","@D"		       ,8 ,0,"","€€€€€€€€€€€€€€","D","","" })
		aAdd(aHeadPro,{"Qtd Disponํvel"	,"B8_XSALPRO","@E 9,999,999.99",12,2,"","€€€€€€€€€€€€€€","N","","" })
		...
		aAdd(aHeadPro,{"Comissใo" 		,"COMISSAO"  ,"@E 999%"		   ,3 ,0,"","€€€€€€€€€€€€€€","N","","" }) 
		...
		If !QRYPRO->(Eof())          
			If cTpMsg=="1"
				Aviso("Aten็ใo","Existem itens, com validade entre 2 e 6 meses, em promo็ใo no sistema."+CHR(10)+CHR(13)+;
								"Comissใo fixada em 10% para a venda de qualquer lote contido na lista."+CHR(10)+CHR(13)+;
								"Os descontos variam de 10% a 40%."+CHR(10)+CHR(13)+;
								"Para escolher um lote em promo็ใo, informe o produto desejado e pressione F11 na linha de itens do pedido.",{"Ok"},3)
			ElseIf cTpMsg=="2"
				Aviso("Aten็ใo","Este produto, possui lote(s) em promo็ใo no sistema."+CHR(10)+CHR(13)+;
								"Comissใo fixada em 10% para a venda de qualquer lote contido na lista."+CHR(10)+CHR(13)+;
								"Os descontos variam de 10% a 40%."+CHR(10)+CHR(13)+;
								"Para escolher um lote em promo็ใo, pressione F11.",{"Ok"},3)
			EndIf   
			...
			DEFINE MSDIALOG oDlg TITLE "Lotes em promo็ใo" From aSize[7],005 TO aSize[6],aSize[5] OF oMainWnd PIXEL      
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณMBROWTMP  บAutor  ณMicrosiga           บ Data ณ  12/21/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
If ParamBox(aBoxParam,"Informe a Quantidade",@aRetParam,,,,,,,,.F.)
	If mv_par01 > aColsPro[oGetPromo:nAt,nPosQtdPro]
		Aviso("Aten็ใo","Quantidade maior do que a do lote escolhido",{"Ok"},1)
